      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>The cleanest UX here is honest routing: email when you need help, GitHub when you want code-level context, and a direct rollout conversation when you are evaluating the product seriously.</p>
          </div>
        }
      />
      ...
      <section className="section-block">
        <div className="shell contact-grid">
          ...
          <Reveal delay={0.06} className="contact-channel">
            ...
            <div className="button-row">
              <a href="mailto:support@krud.ai?subject=Krud%20team%20rollout" className="button button-secondary">
                <LifeBuoy size={15} />
                Discuss rollout
              </a>
            </div>
