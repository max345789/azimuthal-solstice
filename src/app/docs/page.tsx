...
import { CommandWindow, CopyCommand, PageIntro, Reveal } from "@/components/site/ui";
      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>Every section here is grounded in commands or backend behavior already present in the repo.</p>
            <p>If somebody skims only the headings and command snippets, they should still understand the product immediately.</p>
          </div>
        }
      />
        ...
        <div className="shell docs-layout">
          <aside className="docs-nav">
            ...
            <div className="docs-note" style={{ marginTop: "1.2rem" }}>
              <p>Need the backend shape too? The control plane lives in the same product story.</p>
              <a
          ...
          <div className="docs-main">
            <Reveal className="docs-section" id="install">
              ...
              <p>The first step should take seconds. Install the CLI, confirm the binary, and move directly into authentication.</p>
            ...
            <Reveal className="docs-section" id="login">
              ...
              <p><span className="inline-code">krud login</span> starts the device-code flow. The browser approval page only exists to confirm the session cleanly.</p>
            ...
            <Reveal className="docs-section" id="chat">
              ...
              <p>The assistant plans the shell work, proposes commands, and returns a readable explanation of what happened after execution.</p>
            ...
            <Reveal className="docs-section" id="daemon">
              ...
              <p>The daemon path matters because good terminal UX is not only about command generation. It is also about staying responsive while the work continues.</p>
            ...
            <Reveal className="docs-section" id="config">
              ...
              <p>Configuration lives locally and lines up with the control plane settings used by the backend.</p>
            ...
            <Reveal className="docs-section" id="self-host">
              ...
              <p>The FastAPI app already exposes the routes that make the product coherent: device auth, account data, billing flows, chat sessions, and release manifests.</p>
              <div className="config-block">
