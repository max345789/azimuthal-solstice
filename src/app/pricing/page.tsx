...
import { PageIntro, Reveal, SectionHeading } from "@/components/site/ui";
...
const plans = [
  {
    ...
    features: ["Core terminal workflow", "Basic output summaries", "Community support", "Single-operator setup"],
  },
  {
    name: "Pro",
    ...
    features: ["Full command history", "Higher token budget", "Priority product updates", "Deeper model access", "Billing portal access"],
  },
  {
    name: "Team",
    ...
    features: ["Everything in Pro", "Shared operator workflows", "Rollout support", "Priority escalation path", "Custom usage guidance"],
  },
];
      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>Device auth, subscription enforcement, token budgets, and billing routes already exist on the backend side.</p>
            <p>The UI now reflects that maturity without pretending to be more concrete than the current product setup.</p>
          </div>
        }
      />
        ...
        <div className="shell split-section">
          <Reveal>
            ...
            <ul className="comparison-list">
              <li><strong>Free:</strong> evaluate the install, login, and command loop.</li>
              <li><strong>Pro:</strong> use Krud daily with history, budget headroom, and stronger product support.</li>
              <li><strong>Team:</strong> standardize how multiple operators adopt the tool and escalate issues.</li>
            </ul>
          </Reveal>
