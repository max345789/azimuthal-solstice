...
import { ArrowRight, Command, LockKeyhole, ReceiptText, ScanSearch, Server, Waypoints } from "lucide-react";
import { MarketingShell } from "@/components/layout/MarketingShell";
import { CommandWindow, PageIntro, Reveal, SectionHeading } from "@/components/site/ui";
      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>Krud already spans a Rust CLI, a background daemon, and a FastAPI control plane. The interface should feel that deliberate.</p>
            <p>These capabilities are grounded in the backend and CLI already sitting in the repo, not imagined just for the site.</p>
          </div>
        }
      />
