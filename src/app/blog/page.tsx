import { PageIntro, Reveal } from "@/components/site/ui";
...
const posts = [
  {
    ...
    excerpt:
      "The site and product now tell the same story: install fast, approve safely, read the receipt, and keep long-running work in the daemon queue.",
    date: "March 2026",
    read: "4 min read",
  },
  {
    ...
    excerpt:
      "Device login, billing, release metadata, and token budgets are not side features. They are the infrastructure that makes the CLI feel trustworthy.",
    date: "March 2026",
    read: "6 min read",
  },
  {
    ...
    excerpt:
      "A walkthrough of prompt, proposal, approval, log inspection, and readable remediation in one operator loop.",
    date: "February 2026",
    read: "5 min read",
  },
  {
    ...
    excerpt:
      "The sharper UX choice was to make the device-code flow explicit instead of dressing up a surface the product did not need.",
    date: "February 2026",
    read: "4 min read",
  },
];
      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>
              Good product writing should help someone understand why the system
              is built the way it is and what changed.
            </p>
          </div>
        }
      />
        ...
        <div className="shell">
          {posts.slice(1).map((post, index) => (
            ...
            >
              ...
              <div>
                <h3>{post.title}</h3>
                <p style={{ marginTop: "0.6rem", maxWidth: "42rem" }}>
                  {post.excerpt}
                </p>
              </div>
              <div>
