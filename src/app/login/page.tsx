      ...
      <PageIntro
        ...
        aside={
          <div className="meta-panel">
            <p>If you want access today, use the device-code flow from the CLI. That is the strongest and clearest product path in the repo.</p>
          </div>
        }
      />
        ...
        <div className="shell access-grid">
          <Reveal className="access-panel">
            ...
            <div className="button-row">
              <Link href="/docs#login" className="button button-primary">
